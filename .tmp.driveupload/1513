...
while True:
    jugadores = {}
    cantidad_jugadores = int(input("cuantos jugadores queres cargar sin contar el arquero? "))
    ...
    while True:
        ...
        if partes[0] == "crear":
            ...
            cant_defensas = int(input("cuantos defensas queres sin contar el arquero? "))
            cant_medios = int(input("cuantos medios queres sin contar el arquero? "))
            cant_ataques = int(input("cuantos delanteros queres sin contar el arquero? "))
