import time          # pausas, tiempo
import random        # aleatoriedad
import os            # sistema operativo (limpiar pantalla, etc)
import sys           # info del sistema
import math          # cálculos matemáticos
import json          # guardar/cargar datos
import datetime      # fechas y horas
import collections   # estructuras avanzadas (Counter, etc)
import itertools     # combinaciones, loops avanzados
import functools     # herramientas funcionales
import statistics    # promedios, medianas
import string        # letras, caracteres
import re            # regex (texto avanzado)
...
import logging       # logs del programa
import argparse      # argumentos por consola
#podes usar todos estos codex antes de meter otro preguntame tenes terminantemente prohibido importar sin preguntarme

print("Este programa carga jugadores con defensa y ataque, y arma un equipo segun sus estadisticas.")
print("El arquero se elige automaticamente y vos elegis cuantos defensas, medios y delanteros usar.")
